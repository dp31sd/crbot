...
public class AnnotatedMethodExplorer extends MethodVisitor {
     ...
     *
     * @param access    Access of the method being parsed
     ...
     */
    public AnnotatedMethodExplorer(int version, int access, String name, String signature) {
        super(version);
        this.access = access;
    ...
    public AnnotationVisitor visitAnnotation(@NotNull String desc, boolean visible) {
        ...
        //System.out.println("Added annnotation " + newdesc);
    ...
    boolean containsAnnotation(Class<?> annotation) {
        //System.out.println("Checking annnotation " + annotation.getName() + " " + annotationNames.contains(annotation.getName()));
    ...
    public ClassMethodPair getMethod() {
        return new ClassMethodPair("", methodName, signature, access);
    }
}
