...
extends Module {
    ...
    public void onTick() {
        ...
        if (WaterFontRenderer.a() != WaterFontRenderer.b.j) {
            WaterFontRenderer.a((WaterFontRenderer.b)WaterFontRenderer.b.j);
        }
        if ((string = this.spotifyClientId.getValue()) != null && !string.isBlank() && !string.equals(SpotifyAuth.s())) {
            SpotifyAuth.v((String)string);
        }
        resolvedGuiKey = WaterPlus.nameToGlfw(this.guiKeyName.getValue());
    }

    public static void applyGuiKey(int n, String string) {
        if (INSTANCE == null) {
            return;
        }
        WaterPlus.INSTANCE.guiKeyName.setValue(string);
        resolvedGuiKey = n;
    ...
    public static int nameToGlfw(String string) {
        if (string == null) {
            return 344;
        }
        return switch (string) {
            ...
            default -> {
                ...
                if (string.length() == 1) {
                    int var3_17;
                    int var1_2 = GLFW.glfwGetKeyScancode((int)string.charAt(0)) > 0 ? (int)string.toUpperCase().charAt(0) : 344;
                    yield var3_17 = var1_2;
                }
                if (string.startsWith("F") && string.length() <= 3) {
                    try {
                        int var3_18;
                        int var1_3 = Integer.parseInt(string.substring(1));
                        yield var3_18 = (var1_3 = 290 + (var1_3 - 1));
                    }
                    catch (Exception var1_3) {
                        // empty catch block
                    }
                }
                if (string.startsWith("KP")) {
                    try {
                        int var3_19;
                        int var1_4 = Integer.parseInt(string.substring(2));
                        yield var3_19 = (var1_4 = 320 + var1_4);
                    }
