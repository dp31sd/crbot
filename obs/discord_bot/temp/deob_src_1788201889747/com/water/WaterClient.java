...
implements ClientModInitializer {
    public static final Logger field_0;
    ...
    public void onInitializeClient() {
        ...
        HudRenderCallback.EVENT.register((Object)(HudRenderCallback)LambdaMetafactory.metafactory(null, null, null, (Lnet/minecraft/class_332;Lnet/minecraft/class_9779;)V, a(net.minecraft.class_332 net.minecraft.class_9779 ), (Lnet/minecraft/class_332;Lnet/minecraft/class_9779;)V)());
        ClientTickEvents.END_CLIENT_TICK.register((Object)(ClientTickEvents.EndTick)LambdaMetafactory.metafactory(null, null, null, (Lnet/minecraft/class_310;)V, a(net.minecraft.class_310 ), (Lnet/minecraft/class_310;)V)());
    }

    private static /* synthetic */ void method_0(class_310 class_3102) {
    ...
    private static /* synthetic */ void method_1(class_332 class_3322, class_9779 object) {
        try {
            NameTags.renderHud(class_3322, object.method_60637(false));
            PearlESP.renderHud(class_3322, object.method_60637(false));
            object = (RegionMap)ModuleManager.INSTANCE.getModuleByName("Region Map");
            if (object != null && ((Module)object).isEnabled()) {
                object.a(class_3322, class_310.method_1551());
            }
            Hud.a((class_332)class_3322);
            SpotifyHud.a((class_332)class_3322);
            SpotifyQueueHud.visible = Hud.e();
            if (SpotifyQueueHud.visible && (object = class_310.method_1551()) != null) {
                double d2 = object.method_22683().method_4495();
                double d3 = ((class_310)object).field_1729.method_1603() / d2;
                double d4 = ((class_310)object).field_1729.method_1604() / d2;
    ...
    private static /* synthetic */ void method_2(class_310 class_3102) {
    ...
    static {
        a = LoggerFactory.getLogger((String)"Water");
    }
}
