...
import dev.skidfuscator.obfuscator.transform.impl.reference.ReferenceDispatcher;
import dev.skidfuscator.obfuscator.transform.impl.reference.ReferenceDispatcherDump;
...
public class TestSkidfuscator extends Skidfuscator {
    ...
    protected void _loadTransformer() {
        ...
        NativeTransformer.DISPATCHER = TestDispatcher.class;
        NativeTransformer.CACHE = TestCacheTemplate.class;
        ReferenceTransformer.REF_DISPATCHER = TestReferenceDispatcher.class;
        BEFORE_NATIVE = NativeTransformer.DEBUG;
        NativeTransformer.DEBUG = true;
    ...
    protected void _pack() {
        NativeTransformer.DISPATCHER = Dispatcher.class;
        NativeTransformer.CACHE = CacheTemplate.class;
        ReferenceTransformer.REF_DISPATCHER = ReferenceDispatcher.class;
        NativeTransformer.DEBUG = BEFORE_NATIVE;
    }
